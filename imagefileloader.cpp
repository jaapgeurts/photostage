...
unsigned thumb_misc = 360;
unsigned colors = thumb_misc >> 5 & 7;
...
void ImageFileLoader::compute_inverse(float src[9], float dst[9])
{
...
QImage ImageFileLoader::loadRaw()
{
    ...
    if (is_cfa && components_per_pixel==1 && type == TYPE_USHORT16 && bytes_per_pixel==2)
    {
        ...
        //adobe_coeff(ex_info.make.toLocal8Bit().data(), ex_info.model.toLocal8Bit().data());
