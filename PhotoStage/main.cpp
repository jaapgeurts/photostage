...
int main(int argc, char* argv[])
{
  ...
  int id =
      QFontDatabase::addApplicationFont(":/fonts/foundation-icons-general.ttf");
...
//#define STYLE_SHEET 0
  ...
  darkPalette.setColor(QPalette::Normal, QPalette::ButtonText,
                       QColor(Qt::lightGray));
  darkPalette.setColor(QPalette::Normal, QPalette::Light,
                       QColor(Qt::lightGray).lighter(180));
  darkPalette.setColor(QPalette::Normal, QPalette::Midlight,
                       QColor(Qt::lightGray).lighter(150));
  darkPalette.setColor(QPalette::Normal, QPalette::Dark,
                       QColor(Qt::darkGray).lighter(150));
  darkPalette.setColor(QPalette::Normal, QPalette::Mid,
                       QColor(Qt::darkGray).lighter(120));
  darkPalette.setColor(QPalette::Normal, QPalette::Shadow,
                       QColor(Qt::darkGray));
